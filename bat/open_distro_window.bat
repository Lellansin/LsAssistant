...
:epicfail1
set X_ERR1=ERROR: You must run %~nx0 from the root of LsAssistant\bat. %1\bin\gcc.exe not found
...
:epicfail2
set X_ERR1=ERROR: set_distro_paths.bat is missing from the root of LsAssistant\bat.
